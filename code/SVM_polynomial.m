function acc = SVM_polynomial(X,Y,s)
% SVMModel = fitcsvm(X,Y,'Standardize',true,'KernelFunction','polynomial',...
%                 'KernelScale','auto');      
...
features=TrainData;
    ...
    SVMModel = fitcsvm(features,TrainY,'Standardize',true,'KernelFunction','polynomial',...
                'KernelScale','auto');   
